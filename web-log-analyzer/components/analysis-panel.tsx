...
import { Play, Loader2, Users, FileText, Clock, AlertTriangle, HardDrive, Sparkles, Network, Calendar, XCircle, BarChart3, Globe, TrendingUp } from "lucide-react"
...
const ANALYSIS_OPTIONS = [
  ...
  {
    id: "http-methods",
    label: "P6: HTTP Method Distribution",
    description: "Distribution of GET, POST, PUT, DELETE, etc.",
    icon: Network,
  },
  {
    id: "daily-traffic",
    label: "P7: Daily Traffic Counter",
    description: "Request distribution by day of week",
    icon: Calendar,
  },
  {
    id: "error-rate",
    label: "P8: Error Rate Analysis",
    description: "4xx and 5xx error rates and top errors",
    icon: XCircle,
  },
  {
    id: "response-size",
    label: "P9: Response Size Distribution",
    description: "Statistics and distribution of response sizes",
    icon: BarChart3,
  },
  {
    id: "protocol-version",
    label: "P10: Protocol Version Analysis",
    description: "HTTP/1.0, HTTP/1.1, HTTP/2.0 usage",
    icon: Globe,
  },
  {
    id: "peak-traffic",
    label: "P11: Peak Traffic Analysis",
    description: "Identify peak hours and days",
    icon: TrendingUp,
  },
]
